...
## Lunar IDE
To install Lunar IDE, go to the [releases page](https://github.com/S7y1e/lunar-ide/releases)
...
Download the plugin file from the [releases page](https://github.com/S7y1e/lunar-ide/releases)
