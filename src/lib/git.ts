...
export const gitLog = (limit?: number): Promise<GitCommit[]> =>
    invoke("git_log", { limit });
export const gitStage = (path: string): Promise<void> => invoke("git_stage", { path });
export const gitUnstage = (path: string): Promise<void> =>
    invoke("git_unstage", { path });
export const gitStageAll = (): Promise<void> => invoke("git_stage_all");
export const gitDiscard = (path: string): Promise<void> =>
    invoke("git_discard", { path });
