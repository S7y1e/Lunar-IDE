...
// A self-contained Luau sampler driven over the bridge's eval channel: it polls
// the Stats service every 250ms and prints one JSON line per sample, which the
// panel reads back from the runtime stream (no Rust/plugin changes needed).
