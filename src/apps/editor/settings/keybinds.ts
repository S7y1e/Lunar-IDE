...
// index.tsx; the keydown handler there runs the matching command.
...
export const BINDABLE: Bindable[] = [
    ...
    { id: "view.hierarchy", label: "Go to: Hierarchy", defaultKey: "Ctrl+Alt+H" },
...
export const keybindKey = (id: string) => `lunar.keybind.${id}`;
